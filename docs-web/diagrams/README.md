...
| `erd.drawio` | ERD — 19개 엔티티와 관계(카디널리티 포함, AIOps 4종·보안 관제 2종 포함) | [데이터 모델](../docs/04-design/data-model.md) |
...
프론트엔드 정보구조(IA) 다이어그램은 시안과 함께 [`frontend-design/frontend-ia.drawio`](../../frontend-design/frontend-ia.drawio)에 있다.
