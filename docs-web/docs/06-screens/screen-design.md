...
<div class="scr">
  ...
  <div class="scr-cap"><b>A1. 운영 대시보드</b>참조 디자인 그대로 — 가동률·이상 건수 KPI, 전 서버 상태 표(사용률·헬스 점수), 우측 미해결 이상·점검 예정 패널, 하단 자원 추이 차트. (UC14~UC19)</div>
</div>
<div class="scr">
  <div class="scr-frame">
    <div class="scr-side"><span></span><span class="on"></span><span></span><span></span><span></span></div>
...
<div class="scr">
  <div class="scr-frame">
    ...
    <div class="scr-body">
      <div class="m-top"></div>
      <div class="m-cols">
        <div class="m-main"><div class="m-chart"><span style="height:30%"></span><span style="height:45%"></span><span style="height:85%" class="warn"></span><span style="height:90%" class="warn"></span><span style="height:50%"></span><span style="height:40%"></span></div></div>
        <div class="m-aside"><div class="m-list"><i class="bad"></i><i class="warn"></i><i class="warn"></i><i class="ok"></i></div></div>
      </div>
    </div>
  </div>
  <div class="scr-cap"><b>A3. AIOps 모니터링</b>이상 탐지(μ±2σ) 기록 타임라인, 서버별 헬스 점수 추이, 유휴 자동 회수 내역, 용량·장애 예측(F31~F34 도입 시). (UC15·UC18·UC19)</div>
</div>
<div class="scr">
  <div class="scr-frame">
    <div class="scr-side"><span></span><span></span><span></span><span class="on"></span><span></span></div>
    <div class="scr-body">
      <div class="m-top"></div>
      <div class="m-table"><i></i><i></i><i></i><i></i><i></i><i></i></div>
    </div>
  </div>
  <div class="scr-cap"><b>A4. 감사 로그</b>행위자·행위·대상·시각 검색/필터. 잠금·삭제 등 민감 작업 추적. (UC21)</div>
</div>
</div>

| 화면 | 핵심 기능 | UC |
|---|---|---|
| A1 운영 대시보드 | KPI·전 서버 상태·이상 패널·자원 추이 | UC14 UC15 UC16 UC18 UC19 |
| A2 서버 관리 | 등록·수정·점검 전환·삭제·점검 일정 | UC11 UC12 UC13 |
| A3 AIOps 모니터링 | 이상 기록·헬스 추이·회수 내역·예측 | UC15 UC18 UC19 |
| A4 감사 로그 | 민감 작업 검색·추적 | UC21 |
...
| 중간 | S1·S6, M1·M2, A2 | 역할별 차별점(승인·Quota·서버 관리)을 보여주는 화면 |
| 낮음 | S3, M3, A1·A3·A4 | 차트·모니터링 — 백엔드 메트릭 API 안정화 이후 |
